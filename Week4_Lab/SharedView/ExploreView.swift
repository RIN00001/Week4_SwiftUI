...
struct ExploreView: View {
    ...
    var filtered: [Book] {
        if query.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty { return appModel.allBooks }
    ...
    var body: some View {
        NavigationStack {
            ...
            .searchable(text: $query, placement: .navigationBarDrawer(displayMode: .always), prompt: "Search titles or authors")
        }
    }
}
